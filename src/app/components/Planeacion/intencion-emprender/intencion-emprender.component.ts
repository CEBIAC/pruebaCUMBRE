...
export class IntencionEmprenderComponent implements OnInit {
  copys = [
    'Cuando pienso en generar ingresos, me atrae más hacerlo a través de un proyecto de emprendimiento propio que por medio de un mejor empleo.',
  ...
  seleccionar(event, opt) {
    this.select = opt;
    this.rptasEmprender[this.index] = parseFloat(event.srcElement.value);
