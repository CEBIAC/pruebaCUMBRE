...
export class PdfService {
  ...
  // async generarPDF(name, date, copys: Average, copyGlobal, screenshots) {
  ...
  //   //Chart 1
  //   const jpgImage1Bytes = await fetch(screenshots[0]).then((res) => res.arrayBuffer())
  //   const jpgImage1 = await pdfDoc.embedJpg(jpgImage1Bytes)
  ...
  //   page1.drawText('Locus de control', {
  //     x: 70,
  //     y: y2 - 340,
  //     size: copy2Size,
  //     color: rgb(82 / 255, 195 / 255, 168 / 255),
